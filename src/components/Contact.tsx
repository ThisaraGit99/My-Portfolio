              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@thisaranavod.com" className="text-muted-foreground hover:text-blue-accent transition-colors">
                      contact@thisaranavod.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+94123456789" className="text-muted-foreground hover:text-blue-accent transition-colors">
                      +94 123 456 789
                    </a>
                  </div>
                </div>
